...
| APP 1 | Transparency and Privacy policies | Clear, legible, accessible, APP Privacy policy that explains : <ul><li> Kind of information collected; </li> <li>  How it is held; </li> <li>- How it can be accessed to be corrected;</li>  <li> Process for complaints on breach of APPs.</li>  <li> If it is likely to be disclosed overseas</li> |
|--------|---------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| APP 5 | Notification of the collection of personal information | Provides that organisation must make individuals aware of the practices of their privacy policy:,- what is collected;,- how it is used (if it's disclosed);,- how it can be corrected; -,how it is secured;,- and, contact details of the APP entity;,- If data is collected about the individual from anyone other than the individual themselves (e.g. another organisation / credit reporting);,- If the collection is required by law (if so which law) Consequences to the individual if the info is not collected How it can be accessed by the individual |
...
| APP 7 | Direct marketing | Governs the use of PI to communicate directly with an individual to promote goods. It provides tha PI can only be used for this purpose in certain circumstances/ conditions:,Where an individual would reasonable expect it (such as with informed consent),Must have a clear option to opt out,Must stop when an individual opts out |
...
| APP 9 | Adoption, use or disclosure of government related identifiers | Limits when organisations may adopt use or disclose govt identifiers:,Medicare numbers,tax file numbers,Australian passport numbers,[NB separate legislation also governs use of these identifiers] |
