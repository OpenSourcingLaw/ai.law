...
| ﻿APP 1 ,Transparency and Privacy policies ,"Clear, legible, accessible, APP Privacy policy that explains | <ul><li> Kind of information collected; </li> <ul><li>-  How it is held; </li> <ul><li>-  How it can be accessed to be corrected;</li>  <ul><li>-  Process for complaints on breach of APPs.</li>  <ul><li>-  If it is likely to be disclosed overseas</li> |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| " |  |
| APP 2 ,Anonymity and Psuedonymity ,Reflects ‘right to be anonymous’ give individuals the option of not identifying themselves |  |
| APP 3,Collection of solicited information ,Provides when and how an organisation may collect personal and sensitive information. Must not be collected unless it is reasonably necessary to an organisations activities (service it delivers) . |  |
...
| APP 5,Notification of the collection of personal information ,"Provides that organisation must make individuals aware of the practices of their privacy policy | <ul><li> - what is collected; </li> <ul><li> - how it is used (if it ‘s disclosed);</li> <ul><li>  - how it can be corrected;<ul><li> -  how it is secured; </li> <ul><li> - and, contact details of the APP entity; </li><ul><li> - If data is collected about the individual from anyone other than the individual themselves (e.g. another organisation / credit reporting);</li> <ul><li>  - If the collection is required by law (if so which law) Consequences to the individual if the info is not collected How it can be accessed by the individual </li>" |
| APP 6,use or disclosure of personal information ,If an organisation collects information for a purpose (the primary purpose – by APP3 we know that purpose being reasonably necessary for the organisations activities) it must not use the information for another purpose (a secondary purpose). Other uses are only available by obtaining consent |  |
| APP 7,Direct marketing ,"Governs the use of PI to communicate directly with an individual to promote goods. It provides tha PI can only be used for this purpose in certain circumstances/ conditions |  |
| <ul><li> Where an individual would reasonable expect it (such as with informed consent) </li> <ul><li> Must have a clear option to opt out </li> |  |
| <ul><li> Must stop when an individual opts out </li> |  |
| " |  |
| APP 8 ,Cross border disclosure of personal information ,"Limits on disclosure of personal information outside Australia – generally only to recipients with information privacy laws substantially similar to our own. 		"  |  |
| APP 9,Adoption use or disclosure of government related identifiers ,"Limits when organisations may adopt use or disclose govt identifiers | <ul><li> Medicare numbers</li> <ul><li>  tax file numbers</li> <ul><li> Australian passport numbers <ul><li> [NB separate legislation also governs use of these identifiers] </li> |
| " |  |
| APP 10,Quality of personal information ,Reasonable steps that the information is accurate up to date and complete |  |
| APP 11,Security of personal information ,Reasonable steps to protect the information. |  |
| APP 12,Access to personal information ,Must provide access when requested by an individual (to their own info) . |  |
| APP 13 ,Correction of personal information ,Must facilitate requests by individuals to have their information corrrected. |  |

## Source: Understanding terms of use  
